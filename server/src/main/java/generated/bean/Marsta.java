...
@Table()
public class Marsta   implements java.io.Serializable  {
	...
	@Override()
	public Marsta clone() throws CloneNotSupportedException {
		Marsta obj=(Marsta)super.clone();
		return obj;
